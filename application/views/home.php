...
<div class="row">
	<div class="forum col-lg-9">
		<div class="category">
			<div class="topic"><a href="">MapleStory General</a><a href="<?php echo base_url('thread/new') ?>" class="float-right"><span class="jam jam-plus"></span> New</a></div>
			<div class="threads">
			...
			<a href=""><div class="more text-muted">More &raquo;</div></a>
		</div>
		<div class="category">
			<div class="topic">MapleStory Market</div>
			<div class="threads">
				<div class="thread">
					<span class="title">Title of a thread</span>
					<span class="replies">&middot; 4 &middot;</span>
		...
		<div class="category">
			<div class="topic">Video Games</div>
			<div class="threads">
				<div class="thread">
					<span class="title">Title of a thread</span>
					<span class="replies">&middot; 4 &middot;</span>
